...
#		print (f"{M} cookie invalid");jeda(2)
	...
	if romz in ['']:
		...
		if us in['no','No','NO']:
			...
			uas = ("Mozilla/5.0 (Linux; Android 4.1.2; HTC Desire X Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.99 Mobile Safari/537.36 OPR/50.6.2426.201126")
